...
- See [good first issues](https://github.com/Unity-Billal-mesloub/llama.cpp/issues) for tasks suitable for first contributions
- Make sure to read this: [Inference at the edge](https://github.com/Unity-Billal-mesloub/llama.cpp/discussions)
...
- [GGML tips & tricks](https://github.com/Unity-Billal-mesloub/llama.cpp/wiki/GGML-Tips-&-Tricks)
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "LlamaFramework",
            url: "https://github.com/Unity-Billal-mesloub/llama.cpp/releases/download/b5046/llama-b5046-xcframework.zip",
...
- [stb-image](https://github.com/Unity-Billal-mesloub/stb) - Single-header image format decoder, used by multimodal subsystem - Public domain
- [miniaudio.h](https://github.com/[mackron](https://github.com/Unity-Billal-mesloub/miniaudio)/miniaudio) - Single-header audio format decoder, used by multimodal subsystem - Public domain
- [subprocess.h](https://github.com/Unity-Engineering-software-engineering/subprocess.h) - Single-header process launching solution for C and C++ - Public domain
